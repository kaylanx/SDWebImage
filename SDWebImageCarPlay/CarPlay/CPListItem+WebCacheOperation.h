...
/**
 These methods are used to support canceling for CPListItem  image loading, it's designed to be used internal but not external.
 ...
 */
@interface CPListItem (WebCacheOperation)
